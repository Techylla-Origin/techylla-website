        ...
        <div className="w-full overflow-x-hidden">
            ...
            <section className="relative bg-white py-20 min-h-screen overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="/Business-Transformation-Hero.png"
                        alt="Business Transformation Background Image"
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="group rounded-3xl p-4 bg-gradient-to-b from-white/5 to-transparent border border-white/10 backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(100,150,255,0.3)]">
                        ...
                        <div className="rounded-2xl overflow-hidden mb-6">
                            <img src="/Requirement-First-Engineering.png" alt="Requirement-First Engineering Image" className="w-full h-40 object-cover group-hover:scale-105 transition duration-700" />
                        </div>

                        <h3 className="text-lg md:text-xl text-blue-300 mb-3 text-center">Requirement-First Engineering</h3>
                        <p className="text-sm text-gray-200 text-center tracking-wide">
                            Custom-built systems tailored to your exact business needs.
                        </p>
                    </div>
                    ...
                    <div className="group rounded-3xl p-4 bg-gradient-to-b from-white/5 to-transparent border border-white/10 backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(100,150,255,0.3)]">
                        ...
                        <div className="rounded-2xl overflow-hidden mb-6">
                            <img src="/Process-Streamlining.png" alt="Process Streamlining Image" className="w-full h-40 object-cover group-hover:scale-105 transition duration-700" />
                        </div>

                        <h3 className="text-lg md:text-xl text-blue-300 mb-3 text-center">Process Streamlining & Automated Workflows</h3>
                        <p className="text-sm text-gray-200 text-center tracking-wide">
                            Eliminating bottlenecks with efficient, automated workflows.
                        </p>
                    </div>
                    ...
                    <div className="group rounded-3xl p-4 bg-gradient-to-b from-white/5 to-transparent border border-white/10 backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(100,150,255,0.3)]">
                        ...
                        <div className="rounded-2xl overflow-hidden mb-6">
                            <img src="/Lean-Enterprise-Workflows.png" alt="Lean Enterprise Workflows Image" className="w-full h-40 object-cover group-hover:scale-105 transition duration-700" />
                        </div>

                        <h3 className="text-lg md:text-xl text-blue-300 mb-3 text-center">Lean Enterprise Workflows</h3>
                        <p className="text-sm text-gray-200 text-center tracking-wide">
                            Optimized processes ensuring speed, consistency, and data integrity.
                        </p>
                    </div>
                    ...
                    <div className="group rounded-3xl p-4 bg-gradient-to-b from-white/5 to-transparent border border-white/10 backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(100,150,255,0.3)]">
                        ...
                        <div className="rounded-2xl overflow-hidden mb-6">
                            <img src="/Smart-Process-Automation.png" alt="Smart Process Automation Image" className="w-full h-40 object-cover group-hover:scale-105 transition duration-700" />
                        </div>

                        <h3 className="text-lg md:text-xl text-blue-300 mb-3 text-center">Smart Process Automation</h3>
                        <p className="text-sm text-gray-200 text-center tracking-wide">
                            Touchless systems with real-time visibility and control.
                        </p>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <MetricCard title="Reduction in Decision Latency" value="30–40%" highlight icon={Timer} />
                            ...
                            <div className="sm:col-span-2">
                                <MetricCard
                                    title="Reduction in Manual Bottlenecks"
                                    value="50%"
                                    large
                                    highlight
                                    icon={FilterX}
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <MetricCard title="Workflow Execution Speed" value="3X" highlight icon={ZapIcon} />
                                <MetricCard title="Automation of Business Workflows" value="60%" highlight icon={WorkflowIcon} />
                            </div>
            ...
            <section className={`${urbanist.className} relative bg-black text-white py-16 px-6 md:px-12 overflow-hidden`}>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    {/* Card 1 */}
                    <Link href="/case-studies/story-2" className="group block">
                        <div className="rounded-3xl overflow-hidden border border-white/20 bg-black/80 
                          ...
                          shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:-translate-y-1">
                            ...
                            <div className="overflow-hidden">
                                <img
                                    src="/SAP-1.png"
                                    alt="Transforming Supply Chains into Scalable, Automated Systems with SAP Integration Image"
                           ...
                           group-hover:scale-105 transition duration-500"
                            ...
                            <div className="p-5 md:p-6 flex flex-col justify-between h-[140px] md:h-[160px]">
                                <h3 className="text-base md:text-lg font-medium leading-snug mb-4">
                                    Transforming Supply Chains with Scalable SAP Automation
                                </h3>
                          ...
                          shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:-translate-y-1">
                            ...
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Transforming Production with AI-Driven Early Warning Systems Image"
                                    className="w-full h-[200px] sm:h-[220px] object-cover 
                           group-hover:scale-105 transition duration-500"
                                />
                            </div>
                            ...
                            <div className="p-5 md:p-6 flex flex-col justify-between h-[140px] md:h-[160px]">
                                <h3 className="text-base md:text-lg font-medium leading-snug mb-4">
                                    Transforming Production with AI-Driven Early Warning Systems
                                </h3>
