            ...
            <div className={`max-w-7xl mx-auto px-6`}>
                ...
                <div className="grid lg:grid-cols-3 gap-6 py-20 md:py-28">
                    <div className="lg:col-span-2">
                        ...
                        <h1 className={`md:font-normal font-semibold text-black md:mb-8 mb-5 md:text-5xl text-3xl`}>
                            Global Tariff Financial Modeling System
                        </h1>

                        <div className="md:hidden mb-5">
                            <motion.img
                                src="/CaseStudy-1-Img.png"
                        ...
                        <p className={`  md:text-lg text-sm text-gray-700 mb-8`}>
                            ...
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Built a <span className="text-gray-900 font-semibold"> unified Common Data Layer</span>, consolidating data from <span className="text-gray-900 font-semibold"> multiple enterprise systems </span> to create a single source of truth for tariff intelligence
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Developed an advanced <span className="text-gray-900 font-semibold"> What-If Simulation Engine</span>, enabling instant scenario testing across <span className="text-gray-900 font-semibold"> tariff rates, growth factors, and mitigation strategies with high-speed processing</span>
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Enabled <span className="text-gray-900 font-semibold"> parallel scenario execution with asynchronous processing</span>, allowing multiple simulations to run simultaneously without performance impact
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Leveraged <span className="text-gray-900 font-semibold"> Databricks + PySpark</span> for large-scale data processing and integrated <span className="text-gray-900 font-semibold"> ARIMA-based forecasting</span>, providing visibility into financial impact up to <span className="text-gray-900 font-semibold"> 36 months ahead</span>

                        </p>
                        <h2 className={`  md:text-3xl text-xl mb-3 font-semibold mt-4`}>Security & Governance</h2>
