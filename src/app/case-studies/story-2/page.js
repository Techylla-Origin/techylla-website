            ...
            <div className={`max-w-7xl mx-auto px-6`}>
                ...
                <div className="grid lg:grid-cols-3 gap-6 py-20 md:py-28">
                    <div className="lg:col-span-2">
                        ...
                        <h1 className={`  md:font-normal font-semibold text-black md:mb-8 mb-5 md:text-5xl text-2xl`}>
                            Transforming Supply Chain Operations with SAP-Based Intercompany Automation
                        </h1>

                        <div className="md:hidden mb-5">
                            <motion.img
                                src="/CaseStudy-2-Img.png"
                                alt="Illustration of automated global supply chain and intercompany operations"
                        ...
                        <p className={`  md:text-lg text-sm text-gray-700 mb-8`}>
                            ...
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Automated <span className="text-gray-900 font-semibold"> end-to-end intercompany transaction flows</span>, across purchase, transfer, and sales processes, eliminating manual intervention
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                    ...
                    <div className="hidden lg:block lg:col-span-1">
                        ...
                        <div className="mt-8 max-w-[340px] ml-auto">
                            <h2 className={`  md:text-3xl text-xl mb-3 font-semibold mt-4`}>Business Impact</h2>
