            ...
            <div className={`max-w-7xl mx-auto px-6`}>
                ...
                <div className="grid lg:grid-cols-3 gap-6 py-20 md:py-28">
                    <div className="lg:col-span-2">
                        ...
                        <h1 className={`  md:font-normal font-bold text-black md:mb-8 mb-2 md:text-5xl text-3xl`}>
                        ...
                        <p className={`  md:text-lg text-sm text-gray-700 mb-8`}>
                            ...
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Enabled <span className="text-gray-900 font-semibold"> LLM-powered conversational analytics (Quality-GPT)</span> using <span className="text-gray-900 font-semibold"> RAG and Text-to-SQL,</span> allowing users to access insights through natural language
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            ...
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Integrated <span className="text-gray-900 font-semibold"> AI orchestration frameworks (LangChain & LangGraph)</span>  with secure <span className="text-gray-900 font-semibold"> AWS-based infrastructure </span> for scalable and compliant operations
                            <br />
                            <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                            Established a <span className="text-gray-900 font-semibold"> closed-loop intelligence system</span> enabling continuous monitoring, decision-making, and proactive quality management
